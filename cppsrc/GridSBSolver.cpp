...
template <typename FPType>
void GridSBSolver<FPType>::findKeyLngLat(const std::shared_ptr<std::vector<SBLoc<FPType>>> &locData) {
...
template <typename FPType>
void GridSBSolver<FPType>::constructGrid(const std::shared_ptr<std::vector<SBLoc<FPType>>> &locData) {
    row_size_ = sqrt(locData->size()) / AVE_LOC_PER_CELL;
    ...
    grid = std::vector<std::vector<std::unordered_set<const SBLoc<FPType>*>>>(row_size_,
...
template <typename FPType>
void GridSBSolver<FPType>::fillGrid(const std::shared_ptr<std::vector<SBLoc<FPType>>> &locData) {
...
template <typename FPType>
void GridSBSolver<FPType>::Build(const std::shared_ptr<std::vector<SBLoc<FPType>>> &locData) {
