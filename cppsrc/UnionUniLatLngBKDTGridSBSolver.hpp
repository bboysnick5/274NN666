...
protected:
    ...
    struct CellAlloc {
        ...
        value_type* allocate(std::uint_fast8_t N) { return static_cast<value_type*>(::operator new(sizeof(value_type) * n)); }
        void deallocate(value_type* p, std::uint_fast8_t N) { return ::operator delete(static_cast<void*>(p)); }
