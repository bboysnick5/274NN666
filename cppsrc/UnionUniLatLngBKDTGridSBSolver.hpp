...
private:
    ...
    virtual void LoopBody(def::PolicyTag<def::ThreadingPolicy::kSingle>);
    
    virtual void LoopBody(def::PolicyTag<def::ThreadingPolicy::kMultiOmp>);
    
    virtual void LoopBody(def::PolicyTag<def::ThreadingPolicy::kMultiHand>);
