...
public:
    ...
    // std::uint_fast8_t dimension() const;
    // Usage: std::uint_fast8_t dim = kd.dimension();
    // ----------------------------------------------------
...
private:
    ...
    struct TreeNode {
        ...
        TreeNode(std::uint_fast8_t dim_to_expand, const PointND<value_type, N>& k, const ElemType& obj)
        : right(nullptr), dim_to_expand(dim_to_expand), left(nullptr), key(k),
          object(obj) {}
        
        TreeNode(std::uint_fast8_t dim_to_expand, PointND<value_type, N>&& k, ElemType&& obj)
    ...
    std::uint_fast32_t heightHelper(TreeNode *n) const;
    ...
    void kNNValueHelper(TreeNode *cur, std::uint_fast8_t dim, const PointND<value_type, N> &pt,
    ...
    void NNValueHelper(TreeNode*, std::uint_fast8_t dim, const PointND<value_type, N>&,
...
template <typename FPType, std::uint_fast8_t N, typename ElemType, typename PointND<FPType, N>::DistType DT>
constexpr std::uint_fast8_t KDTreeExpandLongest<FPType, N, ElemType, DT>::dimension() const {
    return N;
}

template <typename FPType, std::uint_fast8_t N, typename ElemType, typename PointND<FPType, N>::DistType DT>
typename PointND<FPType, N>::DistType KDTreeExpandLongest<FPType, N, ElemType, DT>::distType() const {
    return DT;
}
...
template <typename FPType, std::uint_fast8_t N, typename ElemType, typename PointND<FPType, N>::DistType DT>
std::uint_fast32_t KDTreeExpandLongest<FPType, N, ElemType, DT>::height() const {
    return heightHelper(root);
}

template <typename FPType, std::uint_fast8_t N, typename ElemType, typename PointND<FPType, N>::DistType DT>
std::uint_fast32_t KDTreeExpandLongest<FPType, N, ElemType, DT>::heightHelper(TreeNode *n) const {
...
template <typename FPType, std::uint_fast8_t N, typename ElemType, typename PointND<FPType, N>::DistType DT>
void KDTreeExpandLongest<FPType, N, ElemType, DT>::kNNValueHelper(TreeNode *cur, std::uint_fast8_t dim,
...
ElemType KDTreeExpandLongest<FPType, N, ElemType, DT>::NNValue(const PointND<FPType, N> &pt) const {
    ...
    /*
     ...
     static std::uint_fast8_t NumOfFullSearch = 0;
