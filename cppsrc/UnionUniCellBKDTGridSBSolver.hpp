...
private:
    ...
    virtual void LoopBody(typename def::Policy_Tag<def::ThreadingPolicy::kSingle>) override;
    virtual void LoopBody(typename def::Policy_Tag<def::ThreadingPolicy::kMultiOmp>) override;
};
